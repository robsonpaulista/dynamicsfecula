...
export default function EditInvestorPage() {
  ...
  const loadInvestor = async () => {
    try {
      ...
      toast({
        title: 'Erro',
        description: error.response?.data?.error?.message || 'Erro ao carregar investidor',
        variant: 'destructive',
      })
  ...
  const onSubmit = async (data) => {
    setLoading(true)
    try {
      await api.put(`/investors/${params.id}`, data)
      toast({
        title: 'Sucesso!',
      ...
      toast({
        title: 'Erro',
        description: error.response?.data?.error?.message || 'Erro ao atualizar investidor',
        variant: 'destructive',
      })
    } finally {
      setLoading(false)
